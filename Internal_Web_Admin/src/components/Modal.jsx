// Simple modal — backdrop + card, dismiss by clicking backdrop or pressing Esc.
...
export default function Modal({ open, onClose, title, children, footer, size = 'md' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40" onClick={onClose}>
      <div
        className={`bg-white rounded-xl shadow-2xl w-full ${widthClass} max-h-[90vh] flex flex-col overflow-hidden`}
