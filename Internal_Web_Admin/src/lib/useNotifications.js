...
//
// Combines an initial fetch of /api/notifications with a live SSE
// subscription so the bell badge stays in sync as new events arrive.
// Returns { notifications, unreadCount, markRead, markAllRead, refresh }.
