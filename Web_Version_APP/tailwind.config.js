...
// Verbatim copy of APP_shopper_and_buyer/tailwind.config.js. Kept in sync
// manually — these tokens are a contract between the shopper web build
// (this folder) and the Android APK source (sibling folder). The content
// array scans the shopper app's source so Tailwind picks up every class
// used by shared components.
export default {
  content: [
    './index.html',
    './src/**/*.{js,jsx}',
    '../APP_shopper_and_buyer/index.html',
    '../APP_shopper_and_buyer/src/**/*.{js,jsx}',
  ],
  darkMode: 'class',
  theme: {
    extend: {
